...
//	console.log('1000000000 '+recordType+ ' : '+primary+' : '+duplicates+' : '+JSON.stringify(callback));
//	this.getRecord('Condition',372, function(err, success){
//		console.log('>>>>>got here '+JSON.stringify(err));
