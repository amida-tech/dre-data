...
//				console.log(JSON.stringify(t));
		    	...
		    	if (source !== undefined && source != null){
		    		...
		    		fc.search({
		    			...
		    			console.log('>>'+JSON.stringify(createdProvenance.entity));
		    			console.log(sourceId);
//		    			console.log('>>>>>>>>'+JSON.stringify(createdProvenance));
...
//	  	console.log("set:" +JSON.stringify(matchSet));
	  	success(null, matchSet);
	}, true);
