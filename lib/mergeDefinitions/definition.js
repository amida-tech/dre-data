...
var definitions = exports.definitions = {
	...
	"MedicationOrder":{
		...
		matchCriteria:{
				...
				text:[0,-1],
				meta:[0,0],
				reasonReference_reference:[-6,-14],
				medicationReference_reference:[-6,-14],
	...
	"Observation":{
		...
		matchCriteria:{
				...
				effectiveDateTime:[-10, -20],
				effectivePeriod_start:[-10, -15],
				effectivePeriod_end:[-10, -15],
	...
	"Immunization":{
		...
		matchCriteria:{
		        ...
		        vaccineCode_text:{'type':'levenshtien', 'score':[-10, -6]},
		        date: [-10, -25],
		        wasNotGiven: [-10,-10],
				default_value:[-4,-4]
		},
...
exports.calculateScore = function(lhs, rhs, matchMatrix){
	if (_.isUndefined(definitions[lhs.resourceType])){
		return definitions.default_definition.calculateScore(lhs, rhs, matchMatrix);	
	}
	return definitions[lhs.resourceType].calculateScore(lhs, rhs, matchMatrix);	
};
...
var compareDates = function(lhs, rhs){
	
};

var compareDateRanges  = function(lhs, rhs){
